---
layout: case-study
title: "High-Conversion Marketing Site for Maritime Community"
client: "Seartify"
description: "Creating a single-page marketing website to drive user registrations for the Seartify maritime community platform, targeting seafarers, course providers, and recruiters."
hero_image: "/assets/images/project-1.png"
live_url: "https://seartify.com"
tags:
  - "Web Design"
  - "Framer"
  - "Maritime"
...
# Overview Section
overview:
  background: "Seartify is a community web application built for maritime professionals and companies. The website serves as a high-conversion, one-page marketing site designed specifically to drive sign-ups to the Seartify platform. It primarily receives traffic from paid advertisements and needs to clearly communicate the platform's value proposition to increase user registrations."
  goals:
    - "Generate 3,000 user registrations on the Seartify platform by June"
...
design_process:
  ...
  decisions:
    ...
    - title: "Mobile-First Approach"
      description: "Designed with mobile responsiveness as a priority, ensuring optimal user experience across all devices for the global maritime audience."
      icon: "/assets/images/service-3.svg"
    - title: "Framer No-Code Platform"
      description: "Built on Framer platform to ensure client can easily edit and maintain the website independently without technical expertise."
...
solution:
  ...
  showcase_images:
    - url: "/assets/images/project-1.png"
      caption: "High-conversion homepage design with clear value proposition and strategic call-to-action placement"
...
results:
  metrics:
    - value: "20%"
      title: "Target User Registrations"
  ...
  feedback:
    quote: "The website is fantastic. It definitely meets our needs. Some people have visited it, and I got a couple of emails to request me to reach out to them."
    author: "Norhakim"
    title: "Co-Founder at Seartify"
...
takeaways:
  ...
  - title: "Mobile-First Design is Essential for Global Reach"
    description: "Mobile responsiveness and accessibility are critical for reaching maritime professionals who may access the site from various devices and locations."
  - title: "No-Code Platforms Enable Client Independence"
    description: "Building on platforms like Framer allows clients to maintain and update their marketing sites without ongoing technical support."
---
